...
function queryData() {
    var url = '<pss:path type="webapp"/>' + '/statistics/dlQuery/dlData?' + getFrom();
    //alert(url);
...
<div class="electric_lcon" id="electric_Con">
  <ul class="default" id="electric_Con_0">
    <form:form name="dlDataForm" modelAttribute="psdata">
      ...
      <div id="bg" style="height: 30px; text-align: center;">
        <ul id="datamenu_Option" class="cb font1">
          <li id=datamenu_Option_0 style="cursor: pointer;" onclick="changeType(0)">电量数据</li>
        </ul>
      </div>
