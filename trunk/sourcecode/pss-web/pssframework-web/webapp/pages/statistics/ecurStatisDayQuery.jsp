...
<table width="3000" border="0" cellspacing="0" class="gridBody" id="object_table">
  <thead class="tableHeader">
    <tr>
      ...
      <th sortColumn="ecurOverUpuplimitTimeA">A相电流越上上限累计时间(分钟)</th>
      <th sortColumn="ecurOverUplimitTimeA">A相电流越上限累计时间(分钟)</th>
      <th sortColumn="ecurOverUpuplimitTimeB">B相电流越上上限累计时间(分钟)</th>
      <th sortColumn="ecurOverUplimitTimeB">B相电流越上限累计时间(分钟)</th>
      <th sortColumn="ecurOverUpuplimitTimeC">C相电流越上上限累计时间(分钟)</th>
      <th sortColumn="ecurOverUplimitTimeC">C相电流越上限累计时间(分钟)</th>
      <th sortColumn="ecurOverUplimitTimeO">零序电流越上限累计时间(分钟)</th>
      <th sortColumn="ecurPeakA">A相电流最大值(A)</th>
      <th sortColumn="ecurPeakATime">A相电流最大值发生时间</th>
      <th sortColumn="ecurPeakB">B相电流最大值(A)</th>
      <th sortColumn="ecurPeakBTime">B相电流最大值发生时间</th>
      <th sortColumn="ecurPeakC">C相电流最大值(A)</th>
      <th sortColumn="ecurPeakCTime">C相电流最大值发生时间</th>
      <th sortColumn="ecurPeakO">零序电流最大值(A)</th>
