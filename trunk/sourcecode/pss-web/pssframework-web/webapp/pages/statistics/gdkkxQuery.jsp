...
function queryData() {
    var url = '<pss:path type="webapp"/>' + '/statistics/gdkkxQuery/gdkkxData?' + getFrom();
    //alert(url);
...
function exportExcel() {
    if(!fdata.simpleTable) {
        return;
    }
    if(!fdata.simpleTable.exportReport) {
        return;
    }
    fdata.simpleTable.exportReport();
}
</script>
</head>
<body>
<div class="electric_lcon" id="electric_Con">
  <ul class="default" id="electric_Con_0">
    <form:form name="gdkkxDataForm" modelAttribute="psdata">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td width="80" align="center" style="padding-bottom: 4px;">
            <input id="excel" name="excel" type="button" class="btnbg4" style="width:67px; height:21px;" onclick="exportExcel()" value="导 出">
          </td>
          <td>&nbsp;</td>
        </tr>
      </table>
      ...
      <div id="bg" style="height: 30px; text-align: center;">
        <ul id="datamenu_Option" class="cb font1">
          <li id=datamenu_Option_0 style="cursor: pointer;" onclick="changeType(0)">供电可靠性</li>
        </ul>
      </div>
