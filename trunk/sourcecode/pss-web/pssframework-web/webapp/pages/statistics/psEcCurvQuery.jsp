  ...
  <table width="100%" border="0" cellspacing="0" class="gridBody" id="object_table">
    <thead class="tableHeader">
      <tr>
        ...
        <th sortColumn="voltA">A相电压(V)</th>
        <th sortColumn="voltB">B相电压(V)</th>
        <th sortColumn="voltC">C相电压(V)</th>
        <th sortColumn="ecurA">A相电流(A)</th>
        <th sortColumn="ecurB">B相电流(A)</th>
        <th sortColumn="ecurC">C相电流(A)</th>
        <th sortColumn="ecurS">剩余电流(mA)</th>
      </tr>
    </thead>
