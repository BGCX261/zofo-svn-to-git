...
function exportExcel() {
    ...
    if(!data.simpleTable.exportReport) {
        return;
    }
    data.simpleTable.exportReport();
}
</script>
</head>
<body>
...
<ul class="default" id="electric_Con_0">
  <form:form name="/query/sumMeterDataQuery" modelAttribute="smdata">
    ...
    <div id="bngMonitor" align="right" style="width: 100%; position: absolute; text-align: right; margin-top: -26px;">
      <img src="<pss:path type="bgcolor"/>/img/page_excel.GIF" onclick="exportExcel()" width="16" height="16" alt="导出Excel" style="cursor: pointer; border: 1px #DBDBDB solid;" />
      &nbsp;
