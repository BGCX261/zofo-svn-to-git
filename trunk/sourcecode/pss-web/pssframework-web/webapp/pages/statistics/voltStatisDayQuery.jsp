...
<table width="5000" border="0" cellspacing="0" class="gridBody" id="object_table">
  <thead class="tableHeader">
    <tr>
      ...
      <th sortColumn="voltOverUpuplimitTimeA">A相电压越上上限日累计时间(分钟)</th>
      <th sortColumn="voltOverDowndownlimitTimeA">A相电压越下下限日累计时间(分钟)</th>
      <th sortColumn="voltOverUplimitTimeA">A相电压越上限日累计时间(分钟)</th>
      <th sortColumn="voltOverDownlimitTimeA">A相电压越下限日累计时间(分钟)</th>
      <th sortColumn="voltQualifyTimeA">A相电压合格日累计时间(分钟)</th>
      <th sortColumn="voltOverUpuplimitTimeB">B相电压越上上限日累计时间(分钟)</th>
      <th sortColumn="voltOverDowndownlimitTimeB">B相电压越下下限日累计时间(分钟)</th>
      <th sortColumn="voltOverUplimitTimeB">B相电压越上限日累计时间(分钟)</th>
      <th sortColumn="voltOverDownlimitTimeB">B相电压越下限日累计时间(分钟)</th>
      <th sortColumn="voltQualifyTimeB">B相电压合格日累计时间(分钟)</th>
      <th sortColumn="voltOverUpuplimitTimeC">C相电压越上上限日累计时间(分钟)</th>
      <th sortColumn="voltOverDowndownlimitTimeC">C相电压越下下限日累计时间(分钟)</th>
      <th sortColumn="voltOverUplimitTimeC">C相电压越上限日累计时间(分钟)</th>
      <th sortColumn="voltOverDownlimitTimeC">C相电压越下限日累计时间(分钟)</th>
      <th sortColumn="voltQualifyTimeC">C相电压合格日累计时间(分钟)</th>
      <th sortColumn="voltPeakA">A相电压最大值(V)</th>
      <th sortColumn="voltPeakATime">A相电压最大值发生时间</th>
      <th sortColumn="voltValleyA">A相电压最小值(V)</th>
      <th sortColumn="voltValleyATime">A相电压最小值发生时间</th>
      <th sortColumn="voltPeakB">B相电压最大值(V)</th>
      <th sortColumn="voltPeakBTime">B相电压最大值发生时间</th>
      <th sortColumn="voltValleyB">B相电压最小值(V)</th>
      <th sortColumn="voltValleyBTime">B相电压最小值发生时间</th>
      <th sortColumn="voltPeakC">C相电压最大值(V)</th>
      <th sortColumn="voltPeakCTime">C相电压最大值发生时间</th>
      <th sortColumn="voltValleyC">C相电压最小值(V)</th>
      <th sortColumn="voltValleyCTime">C相电压最小值发生时间</th>
      <th sortColumn="averageVoltA">A相平均电压(V)</th>
      <th sortColumn="averageVoltB">B相平均电压(V)</th>
      <th sortColumn="averageVoltC">C相平均电压(V)</th>
    </tr>
  </thead>
