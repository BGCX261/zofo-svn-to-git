  ...
  <dl id="dl04" style="display: none;">
    <dt>
      <div id="Fod">
        ...
        <security:authorize ifAnyGranted="ROLE_RESOURCE_4006">
        <div onmouseover=changeFod(this)><a id="a4006" href="#" onclick="selectMenu('4006', '/statistics/gdkkxQuery'); return false;">供电可靠性</a></div></security:authorize>
        <security:authorize ifAnyGranted="ROLE_RESOURCE_4007">
        <div onmouseover=changeFod(this)><a id="a4007" href="#" onclick="selectMenu('4007', '/statistics/dlQuery'); return false;">电量数据</a></div></security:authorize>
      </div>
    </dt>
  </dl>
